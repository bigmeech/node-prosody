...
Client.prototype._request = function(method, path, body, callback) {
  ...
  var options = clone(this._request_options);
  options.method = method;
  options.path = escape(this._base_path + path);
  ...
  options.headers['Connection'] = method === 'DELETE' ? 'close' : 'keep-alive';
...
Client.prototype.message = function(target, message, callback) {
  ...
  return this._request('POST', '/message/' + target, body, callback);
};
...
Client.prototype.addUser = function(user, password, callback) {
  var body = { message: { password: password } };
...
Client.prototype.modules = function(callback) {
