...
Client.prototype.message = function(target, message, callback) {
  ...
  return this._request('POST', '/message/' + jid_split(target).username, body, callback);
};

Client.prototype.sendMulticast =
Client.prototype.multicast = function(target, message, callback) {
  var body = { message: message, recipients: target };
